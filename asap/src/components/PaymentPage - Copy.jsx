...
const EditPassengerModal = ({ isOpen, onClose, passenger, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xs shadow-xl w-full max-w-md max-h-[75vh] overflow-hidden">
...
const BaggageFeesModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`
        relative bg-white rounded-sm shadow-xl w-full max-w-2xl max-h-[75vh] overflow-hidden
      ...
      `}>
        ...
        <div className="px-6 py-2 overflow-y-hidden max-h-[calc(80vh-120px)]">
          <div className="mb-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
            <div>
              ...
              <div className="border-gray-200 border-r overflow-hidden">
...
const FareRulesModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`
        relative bg-white shadow-xl w-full max-w-2xl max-h-[75vh] overflow-hidden
        transform transition-transform duration-300 ease-out
        ${isOpen ? 'translate-y-0' : 'translate-y-full'}
      `}>
        ...
        <div className="px-6 py-1 overflow-y-auto max-h-[calc(80vh-120px)]">
          <div className="pt-1">
...
const FlightRoute = ({ 
  ...
  <div className="w-full items-center justify-between">
    <div className="flex flex-col sm:flex-row items-center w-auto px-2 sm:px-4 lg:px-30 mb-4">
      ...
      <div className="flex-1 mx-2 sm:mx-6 my-2 sm:my-0">
...
const handleCloseModal = () => {
  ...
  return (
    <div className="w-screen fixed inset-0 z-50 lg:flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-sm p-4 shadow-xl w-full max-w-2xl max-h-[70vh] overflow-hidden mx-4">
        <div className="flex justify-between items-start">
                <div className="text-md font-medium text-gray-700">{flight.route} {flight.date}</div>
...
const FlightDetails = () => {
  ...
  return (
    <div className="bg-white lg:w-full w-screen rounded-sm  shadow-sm p-4 lg:mb-2">
      <div className="flex items-center justify-between lg:mb-6">
        <h2 className="lg:text-xl font-semibold text-gray-700">Flight Details</h2>
        <div className="lg:flex gap-4 text-sm text-[#306cac]">
          <div 
      ...
      <div className="border border-gray-200 rounded-lg p-4 mb-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col  w-1/4  items-end space-y-3">
            <div
              onClick={() => handleOpenFlightModal(flights[0], 'outbound')}
              className="bg-blue-50 text-[#306cac] px-2 py-2 rounded text-xs hover:bg-blue-100 cursor-pointer transition-colors"
            >
              Flight Details
            </div>
            <div className="relative">
      ...
      <div className="border border-gray-200 rounded-lg p-4">
        <div className="flex items-center justify-between ">
          ...
          <div className="flex flex-col items-end w-1/4 space-y-3">
            <div
  ...
  // Simple component without memoization
// Complete replacement for the PassengerDetails component in PaymentPage.jsx
// Complete replacement for the PassengerDetails component in PaymentPage.jsx
const PassengerDetails = () => {
  ...
  return (
    <div className="bg-white w-scree shadow-sm p-6 mb-6">
      <div className='  border-b border-gray-200 mb-4'>
        <h2 className="text-gray-700 text-xl font-semibold mb-4">Passenger Details</h2>
      </div>
      ...
      <div className="bg-orange-50 border border-orange-200 rounded p-3 mb-4 flex items-start gap-3">
        ...
        <p className="text-sm font-medium text-orange-400/75">Traveler names must match the government-issued identification document intended to use during travel</p>
      </div>
      
      {passengers.map((passenger, index) => (
        <div key={`passenger-${passenger.id}`} className="mb-6 w-full">
          {/* Passenger Header */}
          <div className="flex flex-col-3 items-start justify-between w-3/3 mb-4">
            <div className="flex items-start justify-between gap-30">
              <div className="flex flex-col">
                <h3 className="font-semibold text-lg text-gray-700 mb-1">Passenger</h3>
                
                  <div 
                    onClick={() => handleEditPassenger(passenger, index)}
                    className="w-full text-left bg-blue-50 text-[#306cac] px-3 rounded-xs text-xs border border-[#306cac]/20 hover:bg-blue-100 cursor-pointer transition-colors"
                  >
              ...
              <div className="grid grid-cols-2 gap-4 flex-1">
                <div>
                  ...
                  <div className="font-medium text-gray-800">{passenger.lastName}</div>
                </div>
                <div>
                  <label className="block text-xs text-gray-600 mb-1">First Name</label>
                  <div className="font-medium text-gray-800">{passenger.firstName}</div>
                </div>
                <div>
                  <label className="block text-xs text-gray-600 mb-1">Middle Name</label>
                  <div className="font-medium text-gray-800">{passenger.middleName || 'N/A'}</div>
                </div>
                <div>
                  ...
                  <div className="font-medium text-gray-800">
                    ...
                    <span className="text-gray-500 text-sm ml-2">(Adult)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='w-1/12'>
              <div 
                  onClick={() => handleEditPassenger(passenger, index)}
                  className="text-[#306cac] text-center text-sm hover:underline bg-blue-50 px-2 py-1 rounded border border-[#306cac]/20 hover:bg-blue-100 cursor-pointer transition-colors"
                >
                  ✎ Edit
                </div>
            </div>
          ...
          <div className="mt-4 w-full">
            ...
            <div className="flex jus">
              ...
              <div className="bg-gray-100 w-1/3">
                <div
                  ...
                  className="flex items-left justify-between p-3 cursor-pointer hover:bg-gray-100"
                >
                  <div className="flex flex-col items-start ">
                    <span className="text-xs text-gray-600 ">Optional</span>
                    <span className="text-sm  text-gray-700">Redress number</span>
                  </div>
              ...
              <div className="bg-gray-100 w-2/3 border-l border-gray-300 ">
                <div
                  onClick={() => toggleSection('combined')}
                ...
                >
                  <div className="flex flex-col items-start">
                    <span className="text-xs text-gray-600">Optional</span>
                    <span className="text-sm text-gray-700">Frequent flyer and meal preferences</span>
                  </div>
                  <svg
            ...
            {expandedSections.combined && (
              <div className="flex mt-0">
                ...
                <div className="bg-gray-100 w-1/3 border-l border-b border-gray-200 p-2">
                ...
                <div className="bg-gray-100 w-2/3 border-x border-b border-gray-200 p-3">
                  <div className="text-xs font-semibold text-[#306cac] mb-1 hover:underline cursor-pointer">
                    More info
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div>
                      <label className="block text-sm text-gray-700 mb-1">Meal Preference</label>
                      <select className="w-full px-3 py-1 border border-gray-300 rounded-sm text-sm text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400">
                    ...
                    <div>
                      <label className="block text-sm text-gray-700 mb-1">Special Assistance</label>
                      <select className="w-full px-3 py-1 border border-gray-300 rounded-sm text-sm text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400">
                  ...
                  {frequentFlyerPrograms.map((program, programIndex) => (
                    <div key={program.id} className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        <label className="block text-sm text-gray-700 mb-1">Frequent Flyer</label>
                        <select 
                          className="w-full px-3 py-1 border border-gray-300 rounded-sm text-sm text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400"
                      ...
                      <div className="flex items-end gap-2">
                        <div className="flex-1">
                          <label className="block text-sm text-gray-700 mb-1">Program Number</label>
                          <input
                            type="text"
                            placeholder="Enter program number"
                            className="w-full px-3 py-1 border border-gray-300 rounded-sm text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                        ...
                        {frequentFlyerPrograms.length > 1 && (
                          <div
                            ...
                            className="px-3 py-1 text-sm font-bold text-[#306cac] border border-[#306cac] rounded-sm hover:bg-blue-50"
                          >
                            Delete
                          </div>
                        )}
                  ...
                  <div
                    ...
                    className="text-[#306cac] font-semibold text-sm hover:underline cursor-pointer w-full flex justify-end"
                  >
                    + Add Program Number
                  </div>
                </div>
      ...
      <div className="border-t border-gray-200 pt-6 mt-6">
        ...
        <div className="bg-orange-50 border border-orange-200 rounded p-3 mb-4 flex items-start gap-3">
          <div className="w-5 h-5 bg-orange-300/65 rounded-full flex items-center justify-center text-white text-xs font-bold mt-0.5">!</div>
          <p className="text-sm font-medium text-orange-400/75">Confirmation email and phone number fields are required!</p>
        </div>

        <div className="flex items-start gap-6">
          <div className="w-1/3">
            <h3 className="font-medium text-gray-700 mb-2">Contact Person</h3>
            <p className="text-sm text-gray-600">Please provide information about a contact person we should get in touch with in case of schedule change</p>
          </div>
